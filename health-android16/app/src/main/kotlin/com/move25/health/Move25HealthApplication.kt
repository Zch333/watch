    ...
    val graph: HealthGraph by lazy {
        ...
        HealthGraph(
            ...
            releaseEvidence = ReleaseEvidence(
                deviceCapabilityConfirmed = BuildConfig.EVIDENCE_DEVICE_CAPABILITY,
                formalScopesApproved = BuildConfig.EVIDENCE_SCOPES_APPROVED,
                dataQualityValidated = BuildConfig.EVIDENCE_DATA_QUALITY,
                algorithmCardsComplete = BuildConfig.EVIDENCE_ALGORITHM_CARDS,
                privacyImpactComplete = BuildConfig.EVIDENCE_PRIVACY_IMPACT,
                aiSafetyPassed = BuildConfig.EVIDENCE_AI_SAFETY,
                deletionAndExportPassed = BuildConfig.EVIDENCE_DELETION_EXPORT,
                powerBudgetPassed = BuildConfig.EVIDENCE_POWER_BUDGET,
                licenseAndSbomApproved = BuildConfig.EVIDENCE_LICENSE_SBOM,
                storeClaimsReviewed = BuildConfig.EVIDENCE_STORE_CLAIMS,
            ),
            android = android,
            sedentary = sedentary,
            huawei = huawei,
