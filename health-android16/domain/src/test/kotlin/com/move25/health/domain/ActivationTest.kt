...
class ActivationTest {
    private val complete = ReleaseEvidence(true, true, true, true, true, true, true, true)
    ...
    private fun ReleaseEvidence.toBooleanList() = listOf(deviceCapabilityConfirmed, formalScopesApproved,
        ...
        deletionAndExportPassed, powerBudgetPassed)
    ...
    private fun ReleaseEvidence.withMissing(index: Int): ReleaseEvidence {
        ...
        return ReleaseEvidence(values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7])
    }
}
